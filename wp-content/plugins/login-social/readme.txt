...
Donate link: https://huge-it.com/wordpress-login/
Tags: login, wp-login, login logo, authentication, wordpress login, admin login, login form, log in, custom login, Facebook Login, registration, register,
...
* [Wordpress Login](https://huge-it.com/wordpress-login/)
* [Demo Login](https://huge-it.com/wordpress-login-demo-1-login/)
* [FAQ Login](https://huge-it.com/wordpress-login-faq/)
* [User Manual Login](https://huge-it.com/wordpress-login-user-manual/)
* [Login Support](https://huge-it.com/contact-us/)
...
If you think, that you found a bug in our [WordPress Login](https://huge-it.com/wordpress-login/) plugin or have any question contact us at [info@huge-it.com](mailto:info@huge-it.com)
...
1.  [WordPress login](https://huge-it.com/wordpress-login-demo-1-login/)
2.  [WordPress login](https://huge-it.com/wordpress-login-demo-1-login/)
3.  [WordPress login](https://huge-it.com/wordpress-login-demo-1-login/)
4.  [WordPress login](https://huge-it.com/wordpress-login-demo-1-login/)
5.  [WordPress login](https://huge-it.com/wordpress-login-demo-1-login/)
6.  [WordPress Login](https://wordpress.org/plugins/login-social/) - Login admin page
7.  [WordPress Login](https://wordpress.org/plugins/login-social/) - Login admin page
8.  [WordPress Login](https://wordpress.org/plugins/login-social/) - Login admin page
...
* We have fixed the unicode font issue when the plugin would recognize only latin characters and also have added 20 new fonts.

= 1.0.2 =

* 1) Added an option to set the max-min length of passwords
* 2) Added style options for the pop-up border (Pro)
